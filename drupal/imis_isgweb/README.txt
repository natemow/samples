...
==================================
  ...
  4) Set the connection parameters and integration options for the module 
  at http://example.com/admin/user/imis_isgweb
  
  5) Test the sync routine; the module will create user records and populate 
